...
class DataLoader:
    ...
    # # 基础信息 Report
    # file_path_people_In_user_data = "data/user_data.xlsx"  # watsonX_Billing Tool 用户注册表
    # file_path_people_In_PM_PMO_PAL = "data/BmsDtlReportD.csv"  # PM/PMO/PAL人员表
    # file_path_Unregister = "data/2024 Unregister project contact focal with Code.xlsx"  # 项目未注册信息表
    #
    # # CIC & GCG BMS Report
    # read_file_path_CIC_BMS_202401 = "data/RowData/2401/202401 CIC Export BMS Report.xlsx"
    # read_file_path_CIC_BMS_202402 = "data/RowData/2402/202402 CIC Export BMS Report.xlsx"
    # read_file_path_CIC_BMS_202403 = "data/RowData/2403/202403 CIC Export BMS Report.xlsx"
    # read_file_path_CIC_BMS_202404 = "data/RowData/2404/202404 CIC Export BMS Report.xlsx"
    # read_file_path_CIC_BMS_202405 = "data/RowData/2405/202405 CIC Export BMS Report.xlsx"
    # read_file_path_GCG_BMS_202401 = "data/RowData/2401/202401 GCG Consulting BMS Report.xlsx"
    # read_file_path_GCG_BMS_202402 = "data/RowData/2402/202402 GCG Consulting BMS Report.xlsx"
    # read_file_path_GCG_BMS_202403 = "data/RowData/2403/202403 GCG Consulting BMS Report.xlsx"
    # read_file_path_GCG_BMS_202404 = "data/RowData/2404/202404 GCG Consulting BMS Report.xlsx"
    # read_file_path_GCG_BMS_202405 = "data/RowData/2405/202405 GCG Consulting BMS Report.xlsx"
    #
    # # CIC & GCG CATS Report
    # read_file_path_CIC_CATS_202401 = "data/RowData/2401/202401 CIC Export CATS Report.xlsx"
    # read_file_path_CIC_CATS_202402 = "data/RowData/2402/202402 CIC Export CATS Report.xlsx"
    # read_file_path_CIC_CATS_202403 = "data/RowData/2403/202403 CIC Export CATS Report.xlsx"
    # read_file_path_CIC_CATS_202404 = "data/RowData/2404/202404 CIC Export CATS Report.xlsx"
    # read_file_path_CIC_CATS_202405 = "data/RowData/2405/202405 CIC Export CATS Report.xlsx"
    # read_file_path_GCG_CATS_202401 = "data/RowData/2401/202401 GCG Consulting CATS Report.xlsx"
    # read_file_path_GCG_CATS_202402 = "data/RowData/2402/202402 GCG Consulting CATS Report.xlsx"
    # read_file_path_GCG_CATS_202403 = "data/RowData/2403/202403 GCG Consulting CATS Report.xlsx"
    # read_file_path_GCG_CATS_202404 = "data/RowData/2404/202404 GCG Consulting CATS Report.xlsx"
    # read_file_path_GCG_CATS_202405 = "data/RowData/2405/202405 GCG Consulting CATS Report.xlsx"
    #
    # # CIC & GCG Charge Out Report
    # read_file_path_CIC_ChargeOut_202401 = "data/RowData/2401/202401 CIC Export Manual Charge Out Report.xlsx"
    # read_file_path_CIC_ChargeOut_202402 = "data/RowData/2402/202402 CIC Export Manual Charge Out Report.xlsx"
    # read_file_path_CIC_ChargeOut_202403 = "data/RowData/2403/202403 CIC Export Manual Charge Out Report.xlsx"
    # read_file_path_CIC_ChargeOut_202404 = "data/RowData/2404/202404 CIC Export Manual Charge Out Report.xlsx"
    # read_file_path_CIC_ChargeOut_202405 = "data/RowData/2405/202405 CIC Export Manual Charge Out Report.xlsx"
    # read_file_path_GCG_ChargeOut_202401 = "data/RowData/2401/202401 GCG Consulting Manual Charge Out Report.xlsx"
    # read_file_path_GCG_ChargeOut_202402 = "data/RowData/2402/202402 GCG Consulting Manual Charge Out Report.xlsx"
    # read_file_path_GCG_ChargeOut_202403 = "data/RowData/2403/202403 GCG Consulting Manual Charge Out Report.xlsx"
    # read_file_path_GCG_ChargeOut_202404 = "data/RowData/2404/202404 GCG Consulting Manual Charge Out Report.xlsx"
    # read_file_path_GCG_ChargeOut_202405 = "data/RowData/2405/202405 GCG Consulting Manual Charge Out Report.xlsx"
